...
from databas import query,show_proc
...
def crud():
    ...
    menu = ["Add Crime Details", "View Crime Details", "Edit Crime Details", "Remove Crime Details","user query","Procedure"]
    ...
    if choice == "Add Crime Details":
    ...
    elif choice == "user query":
        q = st.text_input("Enter your custom query :")
        result = query(q)
        ...
        st.write("Printing the people involved (victim,criminal and the fir writer) in a case")
